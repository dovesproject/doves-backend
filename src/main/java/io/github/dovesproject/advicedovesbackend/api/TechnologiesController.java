...
public class TechnologiesController {
    ...
    public TechnologiesController(TermsService termsService) {
        this.termsService = termsService;
    }

    @GetMapping(path = "/technologies", produces = APPLICATION_JSON_VALUE)
    public List<Term> technologies(@RequestParam String query) {
